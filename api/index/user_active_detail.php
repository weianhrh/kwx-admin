  ...
  <main class="page">
    <div class="page-title-row">
      <div>
        ...
        <p class="page-desc">沿用旧项目统计口径，只调整成新后台统一视觉；当前字段：<?= h('用户最后活跃时间') ?>。</p>
      </div>
      <div class="top-actions">
        <button class="btn btn-outline" type="button" onclick="goRegister()">注册统计</button>
        <button class="btn is-active" type="button" onclick="goActive()">活跃统计</button>
